...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	common: {
		...
		homeText: {
			...
			// 主页横幅主标题字体大小
			titleSize: "3.8rem",
			// 主页横幅副标题(日常碎碎念,随性生活与轻度折腾)
			subtitle: [
				"Coffee in, occasional productivity out.",
				"今天吃什么,是一个比查 Bug 更让人头疼的问题.",
				"Waiting for Friday since Monday morning.",
				"早睡早起只是一种美好的都市传说.",
				"My favorite exercise is clicking the mouse.",
				"比起研究高深技术,还是找个现成的免费软件更香.",
				"To-do list is full, so I decided to take a nap.",
				"生命在于静止,折腾主打一个随缘.",
				"Closing tabs is the closest I get to cleaning up my life.",
				"偶尔当当腐竹,多数时候在盯着屏幕发呆.",
				"Surviving on snacks and a stable internet connection.",
				"配置配不明白就写死,只要能跑就是好代码."
			],
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
